...
# Test For Patient Should Only See Self On Account Page
    ...
    # Success Should be Visible    Login successfully
    # Click Tab    User Account Management
    # Doctor Should Only See Role Of Patient On Account Page    F129642702
...
# Test For Doctor Should See Self And Patient In Account Page
    ...
    # \    Run Keyword If    '${patientNameText}' != 'F129642705'    Should Be Equal    ${patientRoleText}    patient    
...
# Test For Docter Can Modify An Account
    ...
    # Success Should be Visible    Login successfully
    # Click Tab     User Account Management
    # Click Row By User Account Management    F129642705    F129642705
...
# Test for Docter can delete an account
    ...
    # Success Should be Visible    Login successfully
    # Click Tab     User Account Management
    # Click Row By User Account Management    testAccount    F129642703
